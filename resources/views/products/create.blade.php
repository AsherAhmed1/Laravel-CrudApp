                    ...
                    <form enctype="multipart/form-data" action="{{ route('products.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ old(key: 'sku') }}" class="form-control form-control-lg @error ('sku') is-invalid @enderror" placeholder="Insert product SKU"
                                    name="sku">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ old('price') }}" type="text" class="form-control form-control-lg @error ('price') is-invalid @enderror"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea {{ old('description') }} name="description" class="form-control" cols="30" rows="5"
